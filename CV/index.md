...
### 2007-05 - 2021-01 | Automation Specialist, Programmer, Data Analyst @ Gunks, Inc. 
...
`Fintech` · `B2B` · `ETL` | `Python` · `Django` · `Flask` · `Angular 8+` · `VueJS` · `HTML` 

- Full-stack development with Flask/Django and Angular (w/ ngRx)
- Built data models for SQLAlchemy and RESTful APIs for those models with Flask
- Wrote API clients to interact with external services (Spreedly, DonateDouble, Vanco Payments, Upcity, Virtuous and others)
- Built an SMS-based payment and autoreponder system using Twilio
- Implemented two-factor authentication with Flask & Angular
- Excel/CSV/flatfile file processing (import and export)
- Refactored code for Python3 compliance
- Built the backend of a Java/Spring Boot dynamic form app, including a Drools integration fueled by MongoDB and a system to import rules from Excel
...
### 2022-01+ | Senior Software Engineer @ [Signify Health](https://signifyhealth.com)
...
- Had a lot of ideas that seemed great at the time